 ...
 */
package com.server.discovery.config;

import java.util.Optional;

import com.netflix.discovery.EurekaClient;
import com.netflix.eureka.registry.PeerAwareInstanceRegistry;
import com.server.discovery.repository.ApplicationRepository;
import com.server.discovery.repository.aws.BeanstalkRepository;
import com.server.discovery.repository.eureka.LocaleEurekaRepository;
import com.server.discovery.repository.eureka.RemoteEurekaRepository;
import com.server.discovery.stream.CircuitBreakerStreamServlet;
